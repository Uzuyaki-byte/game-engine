...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!RegisteredTextureLoaders.has(extension)) {
    ...
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", async () => await import("./ddsTextureLoader-SPALE5DR.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", async () => await import("./basisTextureLoader-GCG3FD7H.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", async () => await import("./envTextureLoader-HN27MQ3T.js").then((module) => new module._ENVTextureLoader()));
    }
    ...
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", async () => await import("./ktxTextureLoader-LULGALP6.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", async () => await import("./ktxTextureLoader-LULGALP6.js").then((module) => new module._KTXTextureLoader()));
    }
    ...
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", async () => await import("./exrTextureLoader-FHNX44B5.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
//# sourceMappingURL=chunk-LTME2ODO.js.map
